    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createStudentForm" action="process-student-creation.php" method="POST">
                    <div class="form-group">
                        <label for="txtstudentnumber">Student Number:</label>
                        <input type="text" class="form-control" id="txtstudentnumber" name="txtstudentnumber" required>
                    </div>
                    <div class="form-group">
...
<script>
    // Clear username and password fields in the modal after successful submission
    function clearFields() {
        document.getElementById("txtstudentnumber").value = "";
